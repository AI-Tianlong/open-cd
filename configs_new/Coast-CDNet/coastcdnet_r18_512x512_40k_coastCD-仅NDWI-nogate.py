...
from opencd.models.decode_heads.coastcd_head_nogate import CoastCD_Head
...
model = dict(
    ...
    decode_head=dict(
        ...
        binary_change_head=dict(
            type=FCNHead,
            in_channels=128+32, # 128(BIT输出，+32 embedding)
            in_index=0,
            channels=64,
            num_convs=2,  # 原来是1，这里变成两层
            concat_input=False,
            dropout_ratio=0.1,
            num_classes=2,
            norm_cfg=norm_cfg,
