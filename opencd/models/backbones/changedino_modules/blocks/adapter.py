...
# Current file: .../opencd/models/backbones/changedino_modules/blocks/adapter.py
# Target dir:   .../opencd/models/backbones/changedino_modules/dinov3

_current_dir = os.path.dirname(os.path.abspath(__file__))
_parent_dir = os.path.dirname(_current_dir)
REPO_DIR = os.path.join(_parent_dir, "dinov3")
...
# 也是一样的，我也用三通道输入吧,不然DINOV3的权重需要改变！！！
